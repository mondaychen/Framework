...
public final class FinalProject extends GameScreen{
    ...
    public void build() {
    	...
    	program.quickCreateResource("bunny", "cs4620/gl/shaders/SkySea.vert", "cs4620/gl/shaders/SkySea.frag", null);
    	...
    	ScenePath p = new ScenePath("data/scenes", "FinalProject.xml");
