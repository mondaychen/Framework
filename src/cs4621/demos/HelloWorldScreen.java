...
public class HelloWorldScreen extends GameScreen {
	...
	public void onEntry(GameTime gameTime) {
		...
		program.quickCreateResource("Grid", "cs4621/demos/shaders/Grid.vert", "cs4621/demos/shaders/Grid.frag", null);
	...
	public void draw(GameTime gameTime) {
		...
		ib.bind();
		GL11.glDrawElements(GL11.GL_TRIANGLES, indexCount, GLType.UnsignedInt, 0);
		ib.unbind();
